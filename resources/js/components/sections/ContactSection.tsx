        ...
        <section ref={sectionRef} className="bg-[#f5f5f3] py-20 md:py-32 dark:bg-[#0d0d0d]" id="contact">
            <div className="container mx-auto px-6">
                <div className="mx-auto max-w-5xl">
                    ...
                    >
                        Get in <span className="text-[#f53003] dark:text-[#FF4433]">Touch</span>
                    </h2>
                        ...
                        >
                            <div className="mb-8">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start">
                                        <div className="mr-4 flex h-10 w-10 items-center justify-center rounded-md bg-[#f53003]/10 text-[#f53003] dark:bg-[#FF4433]/10 dark:text-[#FF4433]">
                            ...
                            <div className="flex space-x-4">
                                <a
                                    ...
                                    className="flex h-10 w-10 items-center justify-center rounded-full border border-[#e3e3e0] transition-colors hover:border-[#f53003] dark:border-[#3E3E3A] dark:hover:border-[#FF4433]"
                                >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-md border border-[#e3e3e0] bg-white px-4 py-2 focus:ring-2 focus:ring-[#f53003] focus:outline-none dark:border-[#3E3E3A] dark:bg-[#161615] dark:focus:ring-[#FF4433]"
